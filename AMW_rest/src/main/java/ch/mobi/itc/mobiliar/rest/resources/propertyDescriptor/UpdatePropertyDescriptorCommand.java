...
@Getter
public class UpdatePropertyDescriptorCommand {
    ...
    public UpdatePropertyDescriptorCommand(Integer descriptorId, Integer resourceId, Integer resourceTypeId, PropertyDescriptorDTO descriptorDTO) {
