...
/**
 * Interface which must be implemented by entities that hold Tags
 */
public interface PropertyTagEntityHolder {
    ...
    /**
     * adds a PropertyTag Entity
     *
     * @param propertyTagEntity
     */
    public void addPropertyTag(PropertyTagEntity propertyTagEntity);

    /**
     * removes a PropertyTag Entity
     * @param propertyTagEntity
     */
