...
@Getter
public class CreatePropertyDescriptorCommand implements PropertyDescriptorCommandData {
    ...
    public CreatePropertyDescriptorCommand(Integer resourceId, Integer resourceTypeId, PropertyDescriptorData data) throws IllegalArgumentException {
