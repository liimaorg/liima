 ...
 * @author cweber
 */
public class AMWTemplateExceptionHandler implements TemplateExceptionHandler {
	protected List<TemplatePropertyException> errorMessages = new ArrayList<TemplatePropertyException>();
