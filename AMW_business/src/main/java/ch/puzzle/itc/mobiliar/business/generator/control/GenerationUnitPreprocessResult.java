...
/**
 * This Class holds the Preprocess Result for a Generation Unit
 */
public class GenerationUnitPreprocessResult {
    @Getter
    @Setter
    ...
    public String getErrorMessageAsString() {
        ...
        if(hasErrors()){
            sb.append("Errors in Preprocess of Model");
            for (TemplatePropertyException errorMessage : errorMessages) {
