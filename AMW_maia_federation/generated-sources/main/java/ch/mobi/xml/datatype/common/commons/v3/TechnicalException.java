 ...
 *         &lt;element name="canRetry" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TechnicalException {
     ...
     * 
     */
    public TechnicalException(final List<Message> message, final List<LocalizedMessage> localizedMessage, final boolean canRetry) {
    ...
    /**
     * Gets the value of the canRetry property.
     * 
     */
    ...
    /**
     * Sets the value of the canRetry property.
     * 
     */
    public void setCanRetry(boolean value) {
        this.canRetry = value;
    }
