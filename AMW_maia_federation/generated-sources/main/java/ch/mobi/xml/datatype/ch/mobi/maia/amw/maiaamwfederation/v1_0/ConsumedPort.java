...
/**
 * <p>Java class for ConsumedPort complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ConsumedPort">
 *   &lt;complexContent>
 ...
 *         &lt;element name="providedPortRef" type="{http://xml.mobi.ch/datatype/ch/mobi/maia/amw/MaiaAmwFederation/v1_0}ProvidedPortID"/>
...
@XmlType(name = "ConsumedPort", propOrder = {
    "fcKey",
    "fcLink",
    "displayName",
    "localPortID",
...
public class ConsumedPort {
    ...
    @XmlElement(required = true)
    protected ProvidedPortID providedPortRef;
     ...
     * 
     */
    public ConsumedPort(final String fcKey, final String fcLink, final String displayName, final String localPortID, final String resourceType, final ProvidedPortID providedPortRef, final List<PropertyDeclaration> properties) {
        this.fcKey = fcKey;
        this.fcLink = fcLink;
        this.displayName = displayName;
        this.localPortID = localPortID;
        this.resourceType = resourceType;
        this.providedPortRef = providedPortRef;
    ...
    /**
     * Gets the value of the providedPortRef property.
     * 
     * @return
     *     possible object is
     *     {@link ProvidedPortID }
     *     
     */
    public ProvidedPortID getProvidedPortRef() {
        return providedPortRef;
    }

    /**
     * Sets the value of the providedPortRef property.
     * 
     * @param value
     *     allowed object is
     *     {@link ProvidedPortID }
     *     
     */
    public void setProvidedPortRef(ProvidedPortID value) {
        this.providedPortRef = value;
    }
