...
/**
 * <p>Java class for NotFoundException complex type.
 * 
...
@XmlType(name = "NotFoundException", propOrder = {
    "message",
    "localizedMessage"
})
public class NotFoundException {
     ...
     * 
     */
    public NotFoundException(final List<Message> message, final List<LocalizedMessage> localizedMessage) {
