...
* Skeleton shown only until first successful load; subsequent reloads keep the real fields visible but inert/dimmed and show a small spinner in the title. Should use same spinner animation als the full screen spinner/loader.
