...
$filecontent = file_get_contents('generated.changelog.xml');
...
$filecontent = str_replace('type="TIMESTAMP"', 'type="datetime"', $filecontent);
// replace date to date TODO
$filecontent = str_replace('"date"', '"date"', $filecontent);


// replace 1421231460024 to initial-model
$filecontent = str_replace('1421231460024', 'initial-model', $filecontent);
