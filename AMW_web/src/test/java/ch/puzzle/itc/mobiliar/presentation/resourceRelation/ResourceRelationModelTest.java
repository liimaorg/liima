...
public class ResourceRelationModelTest {
    ...
    public void shouldReturnNewEditRelationIfBothHaveNoIdentifierAndSameSlaveGroupId() {
        // given
        ResourceEditRelation existingEditRelation = new ResourceEditRelation(null, null, null, null, 1, null, null, null,
                null, null, null, null, "CONSUMED", null);
        ResourceEditRelation newEditRelation = new ResourceEditRelation(null, null, null, null, 1, null, null, null, null,
                null, null, null, "CONSUMED", null);
        // when
    ...
    public void shouldReturnNewEditRelationIfBothHaveSameIdentifierAndSameSlaveGroupId() {
        // given
        ResourceEditRelation existingEditRelation = new ResourceEditRelation(null, null, "Test", null, 1, null, null, null,
                null, null, null, null, "PROVIDED", null);
        ResourceEditRelation newEditRelation = new ResourceEditRelation(null, null, "Test", null, 1, null, null, null, null,
                null, null, null, "PROVIDED", null);
        // when
        ResourceEditRelation replaced = relationModel.replaceRelation(newEditRelation, existingEditRelation);
    ...
    public void shouldReturnExistingEditRelationIfBothHaveNoIdentifierAndDifferentSlaveGroupIds() {
        ...
        ResourceEditRelation existingEditRelation = new ResourceEditRelation(null, null, null, null, 1, null, null, null,
                null, null, null, null, "CONSUMED", null);
        ResourceEditRelation newEditRelation = new ResourceEditRelation(null, null, null, null, 2, null, null, null, null,
                null, null, null, "CONSUMED", null);
        // when
        ResourceEditRelation replaced = relationModel.replaceRelation(newEditRelation, existingEditRelation);
    ...
    public void shouldReturnExistingEditRelationIfBothHaveSameIdentifierButDifferentSlaveGroupIds() {
        ...
        ResourceEditRelation existingEditRelation = new ResourceEditRelation(null, null, "Test", null, 1, null, null, null,
                null, null, null, null, "PROVIDED", null);
        ResourceEditRelation newEditRelation = new ResourceEditRelation(null, null, "Test", null, 2, null, null, null, null,
                null, null, null, "PROVIDED", null);
        // when
        ResourceEditRelation replaced = relationModel.replaceRelation(newEditRelation, existingEditRelation);
