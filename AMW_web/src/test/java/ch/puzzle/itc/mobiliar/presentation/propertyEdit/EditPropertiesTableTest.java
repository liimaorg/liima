...
public class EditPropertiesTableTest {
	...
	@Test
	public void onChangedTestingModeEventShouldSetNotYetInitializedTestingFlag() {
		// given
		boolean isTesting = true;
		assertFalse(editPropertiesTable.isTesting());

		// when
		editPropertiesTable.onChangedTestingMode(isTesting);

		// then
		assertTrue(editPropertiesTable.isTesting());
	}
	...
	// break;
	// case TYPE:
	// isEditable = isCurrentFocusOnResourceType();
	// break;
	// }
	//
	// // if testing mode only return properties which are in current focus and are defined only for testing
	// if(isTesting()){
	...
	@Test
	public void isEditableWhenInstanceAndFocusOnResourceTypeWhenInTestingModeShouldReturnFalse() {
		// given
		ResourceEditProperty.Origin propertyDescriptorOrigin = ResourceEditProperty.Origin.INSTANCE;
		...
		editPropertiesTable.onChangedTestingMode(true);
	...
	@Test
	public void isEditableWhenTypeAndFocusOnResourceTypeWhenInTestingModeShouldReturnFalse() {
		// given
		ResourceEditProperty.Origin propertyDescriptorOrigin = ResourceEditProperty.Origin.TYPE;
	...
	@Test
	public void isEditableWhenInstanceAndFocusOnResourceWhenInTestingModeShouldReturnFalse() {
		// given
		ResourceEditProperty.Origin propertyDescriptorOrigin = ResourceEditProperty.Origin.INSTANCE;
	...
	@Test
	public void isEditableWhenTypeAndFocusOnResourceWhenInTestingModeShouldReturnFalse() {
		// given
		ResourceEditProperty.Origin propertyDescriptorOrigin = ResourceEditProperty.Origin.TYPE;
	...
	@Test
	public void isEditableWhenInstanceAndFocusOnResourceTypeAndTestingWhenInTestingModeShouldReturnFalse() {
		// given
		ResourceEditProperty.Origin propertyDescriptorOrigin = ResourceEditProperty.Origin.INSTANCE;

		ResourceEditProperty propertyMock = mock(ResourceEditProperty.class);
		when(propertyMock.getPropertyDescriptorOrigin()).thenReturn(propertyDescriptorOrigin);
		when(propertyMock.isTesting()).thenReturn(true);
	...
	@Test
	public void isEditableWhenTypeAndFocusOnResourceTypeAndTestingWhenInTestingModeShouldReturnTrue() {
		// given
		ResourceEditProperty.Origin propertyDescriptorOrigin = ResourceEditProperty.Origin.TYPE;
	...
	@Test
	public void isEditableWhenInstanceAndFocusOnResourceAndTestingWhenInTestingModeShouldReturnTrue() {
		// given
		ResourceEditProperty.Origin propertyDescriptorOrigin = ResourceEditProperty.Origin.INSTANCE;
	...
	@Test
	public void isEditableWhenTypeAndFocusOnResourceAndTestingWhenInTestingModeShouldReturnFalse() {
		// given
		ResourceEditProperty.Origin propertyDescriptorOrigin = ResourceEditProperty.Origin.TYPE;
