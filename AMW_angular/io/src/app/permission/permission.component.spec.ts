...
describe('PermissionComponent without any params (default: type Role)', () => {
  ...
  it('should have default data', inject(
    ...
    (permissionComponent: PermissionComponent) => {
      ...
      expect(permissionComponent.resourceTypes).toEqual([
        { id: null, name: null }
      ]);
  ...
  it('should invoke some services on ngOnInt', inject(
    [
      PermissionComponent,
      PermissionService,
      EnvironmentService,
    ...
    (
      ...
      // TODO
      // expect(permissionComponent.groupedEnvironments['All']).toContain({
      //   id: null,
      //   name: null,
      //   parent: 'All',
      //   selected: false
      // });
      // expect(permissionComponent.groupedEnvironments['Dev']).toContain(
      //   { id: 1, name: 'U', parent: 'Dev', selected: false },
      //   { id: 2, name: 'V', parent: 'Dev', selected: false }
      // );
      // expect(permissionComponent.groupedEnvironments['Test']).toContain({
      //   id: 3,
      //   name: 'T',
      //   parent: 'Test',
      //   selected: false
  ...
  it('should invoke PermissionService and sort the Restrictions by Permission.name, action on changeRole if selected Role exists', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
    ) => {
  ...
  it('should trim selectedRoleName on changeRole', inject(
    [PermissionComponent],
    (permissionComponent: PermissionComponent) => {
      // given
      permissionComponent.selectedRoleName = ' TESTER ';
  ...
  it('should not invoke PermissionService on changeRole if selected Role does not exist', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
      ...
      // given
      permissionComponent.assignedRestrictions = [
  ...
  it('should convert and trim users (provided as string or Tag) to selectedUserNames on changeUser', inject(
    [PermissionComponent],
    (permissionComponent: PermissionComponent) => {
      // given // when
      ...
      // then
      expect(permissionComponent.selectedUserNames[0]).toBe(
        'stringToBeTrimmed'
      );
      expect(permissionComponent.selectedUserNames[1]).toBe(
        'stringToBeTrimmedToo'
      );
  ...
  it('should invoke PermissionService and sort the Restrictions by Permission.name, action on changeUser if selected User exists', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
  ...
  it('should invoke PermissionService and sort the Restrictions by Permission.name, action on changeUser if selected User (provided as Tag) exists', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
  ...
  it('should not invoke PermissionService on changeUser if selected User does not exist', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
  ...
  it('should not invoke PermissionService on changeUser if selected User (provided as Tag) does not exist', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
  ...
  it('should invoke PermissionService on removeRestriction', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
      ...
      permissionComponent.restriction = {
        id: 122,
        contextName: 'B'
      } as Restriction;
      ...
      // TODO
      // expect(permissionComponent.assignedRestrictions).toContain({
      //   id: 121,
      //   contextName: 'T'
      // });
    }
  ...
  it('should reset the Restriction and error message on cancel', inject(
    [PermissionComponent],
    (permissionComponent: PermissionComponent) => {
      // given
      permissionComponent.restriction = {
      ...
      permissionComponent.backupRestriction = {
        id: 111,
        contextName: 'B',
        permission: { name: 'aPermission' }
      } as Restriction;
  ...
  it('should create a copy of the original Restriction on modifyRestriction', inject(
    [PermissionComponent],
    (permissionComponent: PermissionComponent) => {
      // given
      expect(permissionComponent.restriction).toBeNull();
  ...
  it('should invoke PermissionService.updatePermission on persistRestriction for an existing Restriction', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
  ...
  it('should invoke PermissionService.createPermission on persistRestriction for a new Restriction', inject(
    [PermissionComponent, PermissionService],
    (
      permissionComponent: PermissionComponent,
      permissionService: PermissionService
  ...
  it('should not set create to true and not initialize a Restriction on addRestriction if no User or Role is selected', inject(
    [PermissionComponent],
    (permissionComponent: PermissionComponent) => {
      // given
  ...
  it('should set create to true but not initialize a Restriction on addRestriction if a RoleName is selected', inject(
    [PermissionComponent],
    (permissionComponent: PermissionComponent) => {
      // given
  ...
  it('should set create to true but not initialize a Restriction on addRestriction if a UserName is selected', inject(
    [PermissionComponent],
    (permissionComponent: PermissionComponent) => {
      // given
      permissionComponent.selectedUserNames = ['Tester'];
  ...
  describe('PermissionComponent with param actingUser (delegation mode)', () => {
    ...
    it('should invoke some services on ngOnInt', inject(
      ...
      (
        ...
        spyOn(
          permissionService,
          'getOwnUserAndRoleRestrictions'
        ).and.returnValue(of(restrictions));
        spyOn(environmentService, 'getAllIncludingGroups').and.returnValue(
          of(environments)
        );
        spyOn(resourceService, 'getAllResourceGroups').and.callThrough();
        ...
        expect(resourceService.getAllResourceTypes).toHaveBeenCalled();
        expect(
          permissionService.getOwnUserAndRoleRestrictions
        ).toHaveBeenCalled();
        expect(permissionComponent.assignableRestrictions).toEqual(
          restrictions
        );
