...
export class ServersPageComponent {
  ...
  private getUserPermissions() {
    this.canReadAppServer = this.authService.hasResourcePermission('RESOURCE', 'CREATE', 'APPLICATION');
    this.canReadResources = this.authService.hasPermission('RESOURCE', 'READ');
  }
}
