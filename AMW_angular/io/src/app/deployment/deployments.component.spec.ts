...
describe('DeploymentsComponent (with query params)', () => {
  ...
  it('should extract filters from param on ngOnInit', inject(
    [DeploymentsComponent, DeploymentService],
    (
      ...
      spyOn(deploymentService, 'canRequestDeployments').and.returnValue(
        of(true)
      );
  ...
  it('should enhance filters with the right comparator and comparator options on ngOnInit', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
      ...
      // then
      expect(deploymentsComponent.paramFilters[0].compOptions.length).toEqual(
        1
      );
      expect(deploymentsComponent.paramFilters[1].compOptions.length).toEqual(
        3
      );
  ...
  it('should enhance filters with the right option values on ngOnInit', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
      ...
      spyOn(deploymentService, 'getFilterOptionValues').and.callFake(function(
        param: string
      ) {
  ...
  it('should apply filters ngOnInit ', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
  ...
  it('should call the right service method on exportCSV ', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
      ...
      expect(
        ...
        JSON.stringify(deploymentsComponent.filtersForBackend),
        'd.deploymentDate',
        'DESC'
      );
    }
...
describe('DeploymentsComponent (with illegal query params)', () => {
  ...
  it('should display error message on faulty filters params on ngOnInit', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
...
describe('DeploymentsComponent (without query params)', () => {
  ...
  it('should check permission on ngOnInit', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
  ...
  it('should add a filter', inject(
    ...
    (
      ...
      deploymentsComponent.selectedFilterType = {
        name: 'Application',
        type: 'StringType'
      };
      const deploymentFilters: DeploymentFilterType[] = [
  ...
  it('should remove filter and reset offset on removeFilter', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
  ...
  it('should reset offset on setMaxResultsPerPage', inject(
    [DeploymentsComponent],
    (deploymentsComponent: DeploymentsComponent) => {
      // given
      deploymentsComponent.offset = 10;
  ...
  it('should not add latest deployment job filter more than once', inject(
    [DeploymentsComponent, DeploymentService, NgModel],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService,
  ...
  it('should apply filters and add them to the sessionStorage on applyFilters', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
  ...
  it('should sort out filters without a value on apply filters and add the remaining to the sessionStorage on applyFilters', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
  ...
  it('should clear filters and session storage', inject(
    [DeploymentsComponent],
    (deploymentsComponent: DeploymentsComponent) => {
      // given
  ...
  it('should invoke service with right params on sort', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
  ...
  it('should check permission on showEdit', inject(
    [DeploymentsComponent, DeploymentService, ResourceService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService,
  ...
  it('should confirm a deployment and reload it', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
      ...
      spyOn(deploymentService, 'getWithActions').and.returnValue(
        of(deployment)
      );
  ...
  it('should reject a deployment and reload it', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
  ...
  it('should cancel a deployment and reload it', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
  ...
  it('should invoke the right deploymentService methods with right arguments on changeDeploymentDate', inject(
    [DeploymentsComponent, DeploymentService],
    (
      deploymentsComponent: DeploymentsComponent,
      deploymentService: DeploymentService
      ...
      expect(deploymentsComponent.deployments[1].deploymentDate).toEqual(
        deployment.deploymentDate
      );
    }
  ));
