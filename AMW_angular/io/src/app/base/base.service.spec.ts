...
describe('BaseService', () => {
  ...
  it('should have a getBaseUrl method', inject(
    [BaseService],
  ...
  it('should return the expected value on getBaseUrl method', inject(
    [BaseService],
    (baseService: BaseService) => {
  ...
  it('should have a getHeaders method', inject(
    [BaseService],
    (baseService: BaseService) => {
  ...
  it('should have a postHeaders method', inject(
    [BaseService],
    (baseService: BaseService) => {
